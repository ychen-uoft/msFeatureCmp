...
Raw data (used for examples) is located in the "inst/extdata" directory. The three files (one mzML and two featureXMLs) need to be unzipped before they can be used.
...
- usethis::use_test("test-testName")
